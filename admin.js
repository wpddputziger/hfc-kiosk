  <script>
    const token = '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';
    ...
    function addEntry() {
      ...
      fetch(`https://www.googleapis.com/youtube/v3/playlists?part=snippet&id=${playlistId}&key=AIzaSyBXOnPb8MKxBE1pT6SYvdQdX_87350Nk9g`)
        .then(res => res.json())
        .then(data => {
